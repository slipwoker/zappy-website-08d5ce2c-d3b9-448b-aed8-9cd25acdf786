    ...
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!window.zappyContactFormLoaded) {
        ...
        fetch('https://api.zappy5.com/api/email/contact-form', {
          ...
          body: JSON.stringify({
            websiteId: '08d5ce2c-d3b9-448b-aed8-9cd25acdf786',
            name: name,
            email: email,
            subject: subject,
            message: message,
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Popeat uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
